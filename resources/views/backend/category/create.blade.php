<x-backend.master>
    ...
    <div class="my-3 mx-5  py-5 px-5">
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="my-3">
                <x-form.input name="title" type="text" placeholder="Enter title" label="Title" />
            </div>

            <button type="submit" class="btn btn-primary btn-outline-light border-primary">Save</button>
        </form>
    </div>
</x-backend.master>